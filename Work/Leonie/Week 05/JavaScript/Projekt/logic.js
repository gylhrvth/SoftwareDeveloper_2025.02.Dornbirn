...
function checkGuess() {
    ...
    if (guess < targetNumber) {
        feedback.textContent = "Die Zahl ist zu niedrig. Sie haben " + tryCount + " von 7 Versuchen verbraucht";
        ++tryCount;
        console.log("TryCount: " + tryCount);
    } else if (guess > targetNumber) {
        feedback.textContent = "Die Zahl ist zu hoch. Sie haben " + tryCount + " von 7 Versuchen verbraucht";
        ++tryCount;
        console.log("TryCount: " + tryCount);
    } else {
