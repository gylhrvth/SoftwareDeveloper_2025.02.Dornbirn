...
document.getElementById("dark-mode-toggle").addEventListener("click", () => {
    document.body.classList.toggle("dark-mode");                                // Aktiviert Darkmode
    document.getElementById("dark-mode-toggle").classList.add("hidden");        // Versteckt DarkMode-Button
    document.getElementById("light-mode-toggle").classList.remove("hidden");    // Zeigt LightMode-Button
});

// Lightmode aktivieren
document.getElementById("light-mode-toggle").addEventListener("click", () => {
    document.body.classList.remove("dark-mode");                                // Deaktiviert dunklen Modus
    document.getElementById("light-mode-toggle").classList.add("hidden");       // Versteckt LightMode-Button
    document.getElementById("dark-mode-toggle").classList.remove("hidden");     // Zeigt DarkMode-Button
    document.getElementById("item-input").style.color = "000";                  // Setzt schriftfarbe auf
})