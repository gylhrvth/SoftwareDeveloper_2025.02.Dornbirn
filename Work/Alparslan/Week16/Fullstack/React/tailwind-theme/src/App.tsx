...
function MenuBox(){
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12">
      ...
      <Placeholder title="Holz Farbe" className="w-full min-w-32 min-h-32 col-span-1 lg:col-span-9" />
    </div>
  )
}


function MenuTextWithIcon({ icon, text }: { icon: JSX.Element, text: string }) {
  return (
