...
export default function HeaderSmall() {
  return (
    <header className="header w-full h-25 absolute top-0  ">
      <div className="w-full mx-auto px-4 py-4 flex-row justify-around items-center ">

        <h2 className="w-[30%] text-xl font-bold flex justify-start ml-[10%] mt-1.5">
          <Link href="/">About-Page</Link>
        </h2>
        <nav className="space-x-4 flex justify-end mr-15">
